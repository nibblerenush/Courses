...
void TestOutFromImage()
{
  Canvas canvas;
  canvas.SetSize({ 5, 5 });

  canvas.AddShape(ShapeType::Rectangle, { 2, 2 }, { 10, 10 }, MakeTextureSolid({ 2, 10 }, '+'));
...
void TestEllipse()
{
  ...
  canvas.AddShape(ShapeType::Ellipse, { 1, 1 }, { 5, 5 },
    MakeTextureSolid({ 2, 10 }, '+'));
